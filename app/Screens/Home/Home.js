            ...
            >
                <View style={[GlobalStyleSheet.container, { marginHorizontal: 5, marginVertical: 5,backgroundColor:colors.background,marginBottom:0,paddingBottom:0 }]}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 20 }}>
                        <View style={{ flex:1 }}>
                            <Text style={{ ...FONTS.Marcellus, fontSize: 24, color:colors.title,lineHeight:33 }}>A New Generation{"\n"}of Natural Cosmetic{"\n"}Ingredients</Text>
                        </View>
                ...
                <View style={{ width: '100%',marginBottom:5  }}>
                    <View style={[GlobalStyleSheet.container, { marginHorizontal: 5, marginVertical: 5, }]}>
                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between'}}>
                            <Text style={{ ...FONTS.fontMedium, fontSize: 20, color: colors.title }}>Because You Need Time for{"\n"}Yourself. Blend Beauty in You</Text>
                        </View>
                ...
                <View style={{paddingTop:0,overflow:'hidden',paddingBottom:0}}>
                    <View style={[GlobalStyleSheet.container,{padding:0}]}>
                        ...
                        />
                        <View style={{alignItems:'center',position:'absolute',left:0,top:70,right:0}}>
                            ...
                            >
                                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 15, }}>
                                    {SponsoredData.map((data,index) => {
                                        return(
                                            <View key={index} style={{backgroundColor:colors.card,height:138,padding:20,borderRadius:20,flexDirection:'row',alignItems:'center',justifyContent:'space-between',gap:15}}>
                                                <View style={{flex:1}}>
                                                ...
                                                <View>
                                                    <Image
                                                        style={{height:115,width:86,resizeMode:'contain'}}
                                                        source={data.image}
                                                    />
                                                </View>
                                            </View>
                ...
                <View style={{ backgroundColor: colors.background, width: '100%',}}>
                    <View style={[GlobalStyleSheet.container, { marginVertical: 10,marginBottom:20 }]}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <View style={{ backgroundColor:colors.background, width: '100%', }}>
                    ...
                    <View style={[
                        ...
                        <View style={{marginTop: -70,alignItems:'center',marginBottom:10}}>
                            <ImageSwper3
                                data={PopularData}
                            />
                        </View>
                ...
                <View style={[GlobalStyleSheet.container,{backgroundColor:colors.background,width:'100%',paddingVertical:0}]}>
                    <Image
                ...
                <View style={{ backgroundColor: colors.background, width: '100%', }}>
                    <View style={[GlobalStyleSheet.container, { marginVertical: 10, marginBottom: 0, paddingBottom: 0, }]}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <View style={{ backgroundColor:colors.background, width: '100%', }}>
                    <View style={[GlobalStyleSheet.container, { marginVertical: 10,paddingTop:0,marginTop:0 }]}>
                        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', }}>
