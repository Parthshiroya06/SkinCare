...
const Shopping = () => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.background, flex: 1 }}>
                        ...
                        {lists.map((data, index) => {
                            return (
                                <View
                                    key={index}
                                >
                                    <SwiperBox2 data={data} navigation={navigation} theme={theme} colors={colors} handleDelete={() => deleteItem(index)} />
                                </View>
                            )
                        })}
                    </View>
            ...
            >
                <View style={{ height:Platform.OS === 'windows' ? 130 : 200, width: '100%', backgroundColor: colors.card, flex: 1, paddingHorizontal: 15, position: 'absolute', bottom: 0,paddingTop:10 ,borderTopLeftRadius:25,borderTopRightRadius:25}}>
