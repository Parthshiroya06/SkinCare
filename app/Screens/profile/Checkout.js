            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
                <View style={[GlobalStyleSheet.container, { paddingTop: 10 }]}>
                    ...
                    <View style={{ marginTop: 20, }}>
                        ...
                        <View style={{ height: 120, width: '100%', borderWidth: 1, borderColor: theme.dark ? COLORS.white : colors.border, borderRadius: 8, backgroundColor: colors.card, marginTop: 10 }}>
                            <TextInput
                                style={{
                                    ...FONTS.fontRegular,
                                    fontSize: 15,
