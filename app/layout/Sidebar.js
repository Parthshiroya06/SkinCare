    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.background }}>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                    ...
                    {MenuItems.map((data, index) => {
                        return (
                            ...
                            >
                                <View
                                    style={[{
                                        shadowColor:theme.dark ? "#000": "rgba(150, 184, 169, 0.25)",
                                        shadowOffset: {
                                            width: 2,
                                            height: 2,
                                        },
                ...
                >
                    <Text style={{ ...FONTS.fontSemiBold, fontSize: 13, color: colors.title, marginBottom: 4 }}>Glower<Text style={{ ...FONTS.fontRegular, fontSize: 13 }}> Cosmetic Store</Text></Text>
